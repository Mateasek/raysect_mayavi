...
def add_cornell_box(parent: Node|World) -> Node|World:
    """
    Add a Cornell box from Raysect's examples to the scenegraph node.

    :param parent: The parent node of the Cornell box scene.
    """
    ...
    camera = PinholeCamera((512, 512), parent=parent, transform=translate(0, 0, -3.3) * rotate(0, 0, 0), pipelines=pipelines)
